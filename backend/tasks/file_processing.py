...
def analyze_csv_schema(self, file_path: str):
    ...
    try:
        ...
        schema = {
            "columns": [
                {"name": "id", "type": "integer", "nullable": False, "sample_values": [1, 2, 3]},
                {"name": "name", "type": "string", "nullable": False, "sample_values": ["John", "Jane", "Bob"]},
                {"name": "age", "type": "integer", "nullable": True, "sample_values": [25, 30, None]},
            ],
            "row_count": 1000,
            "file_size": "2.5 MB"
        }
