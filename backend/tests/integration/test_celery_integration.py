...
class TestCeleryIntegration:
    ...
    def test_process_csv_file_task_integration(self, mock_project_service, mock_storage, test_db_setup):
        ...
        mock_project_service_instance.update_project_metadata.return_value = test_project
    ...
    @patch('tasks.file_processing.storage_service')
    @patch('tasks.file_processing.get_project_service')
    def test_celery_error_handling_integration(self, mock_project_service, mock_storage, test_db_setup):
    ...
    def test_celery_result_backend_integration(self):
        ...
        if result_backend:
            ...
            assert any(backend in result_backend.lower() for backend in ['redis', 'db', 'cache'])
