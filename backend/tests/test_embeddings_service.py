...
class TestEmbeddingsService:
    ...
    def test_generate_project_embeddings_no_access(self):
        ...
        result = service.generate_project_embeddings(
        ...
        stored_embeddings = [
            {
                ...
                "embedding": [
                    ...
                    0.5,
                    0.5,
                ],  # Same as query = highest similarity (1.0)
            },
            {
                "type": "column",
    ...
    def test_create_sample_data_description(self):
        ...
        mock_project = Mock()
        mock_project.columns_metadata = [
            {"name": "price", "sample_values": [10.5, 20.0, 15.75]},
            {"name": "category", "sample_values": ["A", "B", "A", "C"]},
        ]
