...
from models.response_schemas import (
    ApiResponse, Project, CreateProjectRequest, CreateProjectResponse,
    PaginatedResponse, PaginationParams, UploadStatusResponse,
    ColumnMetadata, ProjectStatus
)
...
async def get_project_status(
    ...
    status_response = UploadStatusResponse(
        ...
        message="Processing complete" if project_data["status"] == "ready" else "Analyzing CSV schema..."
    )
